...
if (accordion_faq) {
    new accordion_min(accordion_faq, {
        activeClass: '_active',
        openOnInit: [0]
    });
}
...
if (selects.length > 0) {
    selects.forEach(select => {
        nice_select2.bind(select);
    })
}
// EXTERNAL MODULE: ./node_modules/range-slider-input/dist/rangeslider.nostyle.umd.min.js
var rangeslider_nostyle_umd_min = __webpack_require__(654);
;// CONCATENATED MODULE: ./src/js/modules/range-slider.js
...
if (range_sliders.length > 0) {
    range_sliders.forEach(range_slider => {
        ...
        let range_slider_init = rangeslider_nostyle_umd_min(range_slider, {
